    ...
    public class ApplicantEducationLogic : BaseLogic<ApplicantEducationPoco>
    {
        ...
        protected override void Verify(ApplicantEducationPoco[] pocos)
        {
            ...
            foreach(ApplicantEducationPoco poco in pocos)
            {
                ...
                {
                    exceptions.Add(new ValidationException(107, $"Major for applications {poco.Major} cannot be null"));
                }
                ...
                {
                    exceptions.Add(new ValidationException(109, $"CompletionDate of ApplicationEduction{poco.CompletionDate} cannot be earlier than StartDate"));
                }
            }
